        ...
        >
            ...
            <div className="relative z-10 bg-white bg-opacity-90 p-8 rounded-xl shadow-2xl w-full max-w-md">
                ...
                <div className="mt-3 text-sm flex justify-between items-center">
                    ...
                    <Link to="/register" className="py-2 px-5 bg-red-900 text-white border rounded-xl hover:scale-110 duration-300 hover:bg-gray-900 hover:text-white">Registrarse</Link>
                </div>
            </div>
        </div>
    );
